...
<div class="container">
    ...
    <div>
    <p class="lead">add books to the basket</p>
    	<p>ISBN</p>
    	<input value=<%=request.getParameter("ISBN") %> disabled="disabled" class="form-control input-sm" placeholder="ISBN" style = "width:250px">
    	<form action="addToBasket.action" method="get">
    		<div class="form-group">
    		<input value=<%=request.getParameter("ISBN") %> type="hidden" class="form-control input-sm" placeholder="ISBN" name="ISBN" style = "width:250px">
    		<p>Count</p>
